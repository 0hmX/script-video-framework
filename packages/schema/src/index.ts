...
export const visualSchema = z.discriminatedUnion("type", [
  ...
  z.object({ ...visualBase, type: z.literal("illustration.workflow"), variant: z.enum(["kicad-bridge", "source-to-hardware"]) }).strict(),
  z.object({ ...visualBase, type: z.literal("tscircuit.board"), source: localPath, view: z.enum(["pcb", "schematic", "3d"]), motion: z.enum(["none", "slow-zoom"]).default("none") }).strict(),
